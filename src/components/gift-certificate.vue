<template>
  <div class="certificate my-5 my-lg-10">
    ...
    <div class="certificate__content container">
      <div class="certificate__content-wrapper text-body-1">
        ...
        <div class="mt-lg-5 certificate__actions font-weight-bold text-white text-center text-lg-left">
          ...
          <div class="mt-5">
            <v-btn color="#f9a900" :size="$vuetify.display.lgAndUp ? 'x-large' : 'large'"><router-link to="/about">Активировать сертификат</router-link></v-btn>
          </div>
        </div>
      </div>
    </div>
...
<style lang="scss" scoped>
  ...
  .certificate {
    @include layout(60, '@/assets/certificate.png', left, contain);
  }
</style>
